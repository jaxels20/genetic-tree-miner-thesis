    ...
    for subdir, _, files in os.walk(root_dir):
        for file in files:
            if file.endswith(".xes"):
                ...
                xes_files.append(file_path)
                
    return xes_files 

root_directory = "real_life_datasets"
files = collect_all_xes_files(root_directory)
    ...
    data.append(
        {
            ...
            "Events in Longest Trace": max_events_in_trace,
            "Events in Shortest Trace": min_events_in_trace,
...
# to latex
df.to_latex("./real_life_datasets/analysis.tex", index=False)
