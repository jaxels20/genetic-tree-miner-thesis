...
TEST(PrefixCaching, SimpleSequence) {
    PetriNet net;
    ...
    double fitness = calculate_fitness(eventlog, net, true, false);

    EXPECT_EQ(fitness, 1.0);
}

TEST(PrefixCaching, SimpleLoop) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("end", 0));
...
// Example test case
TEST(PrefixCaching, test_simple_sequence_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(PrefixCaching, test_complex_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(PrefixCaching, silent_transition_in_before_end_place) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
