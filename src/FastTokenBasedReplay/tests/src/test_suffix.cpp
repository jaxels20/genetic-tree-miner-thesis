...
TEST(SuffixCaching, SimpleSequence) {
    PetriNet net;
...
// Example test case
TEST(SuffixCaching, test_simple_sequence_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(SuffixCaching, test_complex_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(SuffixCaching, silent_transition_in_before_end_place) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
TEST(SuffixCaching, simple_or){
    ...
    auto fitness = calculate_fitness(eventlog, net, false, true);
