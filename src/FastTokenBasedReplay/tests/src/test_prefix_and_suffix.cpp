...
TEST(PrefixAndSuffixCaching, SimpleSequence) {
    PetriNet net;
...
TEST(PrefixAndSuffixCaching, SimpleLoop) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("end", 0));
...
// Example test case
TEST(PrefixAndSuffixCaching, test_simple_sequence_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(PrefixAndSuffixCaching, test_complex_with_silent_transitions) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
...
// Example test case
TEST(PrefixAndSuffixCaching, silent_transition_in_before_end_place) {
    PetriNet net;
    net.add_place(Place("start", 0));
    net.add_place(Place("p1", 0));
    net.add_place(Place("p2", 0));
